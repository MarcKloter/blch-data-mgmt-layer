...
public class StoreDataIT {
    ...
    @Test
    public void Non_Existent_Attachments() {
    ...
    @Test
    public void Not_Authorized_Attachments() {
    ...
    @Test
    public void Allow_Self_Addressed() {
    ...
    @Test
    public void Store_Data_Multiple_Subjects() {
